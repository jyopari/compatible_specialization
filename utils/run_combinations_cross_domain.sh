...
CUDA_VISIBLE_DEVICES=0 python analyze.py --arch gpt2 --pretrained \
            --datasets tinystories --batch_size 16 --context 1024 \
            --name eval_gpt2_base \
            --eval_sep code_instructions code_textbooks coding_dataset combined_coder_python evol_instruct_code programming_books python_code_dataset python_codes tinycodes orca-math-problems gsm-hard\
...
CUDA_VISIBLE_DEVICES=0 python analyze.py --arch gpt2 --pretrained \
            ...
            --name eval_gpt2_base \
            --eval_sep code_instructions code_textbooks coding_dataset combined_coder_python evol_instruct_code programming_books python_code_dataset python_codes tinycodes orca-math-problems gsm-hard\
            --router_ckpts /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/v1-gpt2-0.0008-1-code_textbooks_finetuned.pt \
                           /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-orca-math-gpt2-0.0008-1-orca-math-problems_finetuned.pt \
            --analyze
...
CUDA_VISIBLE_DEVICES=0 python analyze.py --arch gpt2 --pretrained \
            ...
            --name eval_gpt2_base \
            --eval_sep code_instructions code_textbooks coding_dataset combined_coder_python evol_instruct_code programming_books python_code_dataset python_codes tinycodes orca-math-problems gsm-hard\
            --router_ckpts /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-orca-math-gpt2-0.0008-1-orca-math-problems_finetuned.pt \
                           /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-orca-math-gpt2-0.0008-1-orca-math-problems_finetuned.pt \
            --analyze
...
python analyze.py --arch gpt2-xl --pretrained \
            --datasets tinystories --batch_size 4 --context 1024 \
            --name eval_gpt2_base \
            --eval_sep gsm-hard\
            --router_ckpts /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-combined_coder_python-gpt2-xl-0.0008-1-combined_coder_python_finetuned.pt \
                           /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-orca-math-gpt2-xl-0.0008-1-orca-math-problems_finetuned.pt \
            --analyze