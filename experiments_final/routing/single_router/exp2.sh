...
CUDA_VISIBLE_DEVICES=0 python main.py --arch gpt2 --pretrained \
            --datasets evol_instruct_code --batch_size 92 --context 1024 --train_tokens 160000 \
            --optim adamw --lr 5e-3 --wd 1e-1 --router_method standard --topk 2 --single_router\
