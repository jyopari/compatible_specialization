...
CUDA_VISIBLE_DEVICES=0 python main.py --arch gpt2 --pretrained \
            ...
            --router_ckpts /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-datamix-tinycodes-gpt2-0.0008-1-tinycodes-openwebtext_320000_finetuned.pt \
                           /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-datamix-orca-math-gpt2-0.0008-1-orca-math-problems-openwebtext_320000_finetuned.pt \
            --name gpt_routed_datamix --wandb 