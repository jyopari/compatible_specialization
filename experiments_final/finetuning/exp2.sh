...
python main.py --arch gpt2 --pretrained \
            --dataset evol_instruct_code --batch_size 64 --grad_accum 2 --context 1024 --train_tokens 160000 \
            --optim adamw --lr 8e-5 --wd 1e-1 --train_mlp\
            --out_dir /data/scratch-oc40/pulkitag/jyop/gpt-merge-out \
            --log_freq 100 \
            --name gpt2-evol_instruct_code --wandb 