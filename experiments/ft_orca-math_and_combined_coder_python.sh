...
python main.py --arch gpt2 --pretrained \
            --datasets orca-math-problems combined_coder_python --batch_size 64 --grad_accum 2 --context 1024 --train_tokens 320000 \
            --optim adamw --lr 8e-4 --wd 1e-1 --train_mlp\
            --out_dir /data/scratch-oc40/pulkitag/jyop/gpt-merge-out \
            --log_freq 100 --eval_iter 5 \
            --name gpt2-ocra-math-problems_and_combined_coder_python --wandb 