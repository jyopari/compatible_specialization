...
python main.py --arch gpt2 --pretrained \
            ...
            --log_freq 50 \
            --chkpt /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/rag-bio-text_and_med-qa-gpt2-0.0008-1-rag-bio-text-med-qa_320000_finetuned.pt \
            --name ft_from_base_rag-bio-qa --wandb 