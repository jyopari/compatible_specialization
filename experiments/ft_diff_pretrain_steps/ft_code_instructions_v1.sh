...
python main.py --arch gpt2 --pretrained \
            --dataset code_instructions --batch_size 64 --grad_accum 2 --context 1024 --train_tokens 5600000 \
            --chkpt /data/scratch/jyop/gpt-base-initial-grads/gpt2_base-pretrain_c_adamw_0.0006_0_openwebtext-step:10.pth \
            --optim adamw --lr 8e-4 --wd 1e-1 --train_mlp\
            --out_dir /data/scratch-oc40/pulkitag/jyop/gpt-merge-out \
            --log_freq 100 --eval_iter 5 \
            --name gpt2-code_instructions_step_10_long3 --wandb 