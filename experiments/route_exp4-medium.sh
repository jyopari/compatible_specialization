...
CUDA_VISIBLE_DEVICES=0 python main.py --arch gpt2-medium --pretrained \
            --datasets gsm-hard --batch_size 92 --grad_accum 2 --context 1024 --train_tokens 160000 \
            --optim adamw --lr 5e-3 --wd 1e-1 --name gpt2_route --router_method standard --topk 2\
            --router_ckpts /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-combined_coder_python-gpt2-medium-0.0008-1-combined_coder_python_finetuned.pt \
