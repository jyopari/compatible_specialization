...
CUDA_VISIBLE_DEVICES=0 python main.py --arch gpt2 --pretrained \
            --datasets orca-math-problems-korean --batch_size 92 --context 1024 --train_tokens 160000 \
            --optim adamw --lr 5e-3 --wd 1e-1 --name gpt2_route --router_method standard --topk 2\
            --router_ckpts /data/scratch-oc40/pulkitag/jyop/gpt-merge-out/gpt2-korean-text-gpt2-0.0008-1-korean-text_160000_finetuned.pt \
