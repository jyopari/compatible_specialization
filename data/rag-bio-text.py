...
data_dir = os.path.join(data_dir, 'rag-bio-text')
...
if __name__ == '__main__':
    ...
    # Select the combined column
    dataset = dataset.select_columns('passage')
    dataset = dataset.rename_column('passage', 'text')

    split_dataset = dataset["passages"].train_test_split(test_size=0.005, seed=2357, shuffle=True)
