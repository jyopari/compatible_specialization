...
data_dir = os.path.join(data_dir, 'code_instructions')
...
if __name__ == '__main__':
    # Load the dataset
    dataset = load_dataset("TokenBender/code_instructions_122k_alpaca_style", num_proc=num_proc_load_dataset)
    
    # Combine 'prompt' and 'response' columns
    def combine_columns(example):
        combined_text = example['instruction'] + " " + example['text']
