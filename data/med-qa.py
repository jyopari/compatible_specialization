...
data_dir = os.path.join(data_dir, 'med-qa')
...
if __name__ == '__main__':
    dataset = load_dataset("lavita/medical-qa-datasets", "pubmed-qa")

    # Combine 'prompt' and 'response' columns
    def combine_columns(example):
        combined_text = example['QUESTION'] + " " + example["CONTEXTS"][0] + " " + example['LONG_ANSWER']
