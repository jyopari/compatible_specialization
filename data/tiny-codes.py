...
data_dir = os.path.join(data_dir, 'tinycodes')
...
if __name__ == '__main__':
    # Load the dataset
    dataset = load_dataset("nampdn-ai/tiny-codes", num_proc=num_proc_load_dataset)
    
    # Combine 'prompt' and 'response' columns
    def combine_columns(example):
        combined_text = example['prompt'] + " " + example['response']
