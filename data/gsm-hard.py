...
data_dir = os.path.join(data_dir, 'gsm-hard')
...
if __name__ == '__main__':
    # Load the dataset
    dataset = load_dataset("reasoning-machines/gsm-hard", num_proc=num_proc_load_dataset)
    
    # Combine 'prompt' and 'response' columns
    def combine_columns(example):
        combined_text = example['input'] + " " + example['code']
