...
data_dir = os.path.join(data_dir, 'orca-math-problems-korean')
...
if __name__ == '__main__':
    # Load the dataset
    dataset = load_dataset("kuotient/orca-math-word-problems-193k-korean", num_proc=num_proc_load_dataset)
