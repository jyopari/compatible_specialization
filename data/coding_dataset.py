...
data_dir = os.path.join(data_dir, 'coding_dataset')
...
if __name__ == '__main__':
    # Load the dataset
    dataset = load_dataset("Willl007/coding_dataset", num_proc=num_proc_load_dataset)
    
    # Combine 'prompt' and 'response' columns
    def combine_columns(example):
        combined_text = example['prompt'] + " " + example['output']
